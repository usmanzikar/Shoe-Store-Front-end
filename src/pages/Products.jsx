...
export default function Products() {
  ...
  const filtered = filter === 'Shop All'
    ? dummyProducts
  ...
  return (
    <section className="py-16 px-6 bg-white text-center">
      ...
      {/* Category Filter */}
      <ProductFilter categories={categories} active={filter} onSelect={setFilter} />
      ...
      {/* Explore More Button */}
      <div className="mt-10">
        <button className="px-6 py-3 bg-black text-white font-semibold rounded-md hover:bg-orange-500 transition">
          Explore More
        </button>
      </div>
    </section>
